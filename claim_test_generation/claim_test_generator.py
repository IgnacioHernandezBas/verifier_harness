...
SYSTEM_PROMPT = (
    ...
    "✅ DO: Import ONLY from public APIs:\n"
    "   - import pytest\n"
    "   - from pytest import fixture, raises, mark\n"
    "   - from requests.models import Response\n"
    "   - from astropy.wcs import WCS\n"
    "❌ DON'T: Import from internal/private modules (will cause import errors):\n"
    "   - from _pytest.* import anything  # NEVER\n"
    "   - from src._pytest.* import anything  # NEVER\n"
    "   - from any_package._internal.* import anything  # NEVER\n"
    "\n"
    "You CAN access private attributes AFTER creating an object:\n"
    "   obj = PublicClass(...)\n"
    "   obj._private_attr  # This is OK\n"
    "But NEVER import private modules directly - they may not be available in the test environment."
)
