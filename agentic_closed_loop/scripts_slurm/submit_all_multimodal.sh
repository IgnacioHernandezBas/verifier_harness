...
CLAIMS_MODEL="hugging-quants/Meta-Llama-3.1-70B-Instruct-AWQ-INT4" #Qwen/Qwen2.5-Coder-32B-Instruct-AWQ
TESTS_MODEL="hugging-quants/Meta-Llama-3.1-70B-Instruct-AWQ-INT4" # hugging-quants/Meta-Llama-3.1-70B-Instruct-AWQ-INT4
GPUS="${GPUS:-2}"
